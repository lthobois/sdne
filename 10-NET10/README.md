# Atelier 10 - Validation perimetrique (.NET 10)
...
- `10-NET10/PerimeterValidationLab/Program.cs:14`
- `10-NET10/PerimeterValidationLab/Program.cs:5`

```powershell
if (Test-Path .\10-NET10) { Set-Location .\10-NET10 }
...
Code source a observer:
- `10-NET10/PerimeterValidationLab/Program.cs:20`
- `10-NET10/PerimeterValidationLab/Program.cs:36`
- `10-NET10/PerimeterValidationLab/Security/TrustedProxyPolicy.cs:11`
...
Code source a observer:
- `10-NET10/PerimeterValidationLab/Program.cs:52`
- `10-NET10/PerimeterValidationLab/Program.cs:64`
- `10-NET10/PerimeterValidationLab/Security/TrustedProxyPolicy.cs:46`
...
Code source a observer:
- `10-NET10/PerimeterValidationLab/Program.cs:84`
- `10-NET10/PerimeterValidationLab/Security/TrustedProxyPolicy.cs:11`
...
Code source a observer:
- `10-NET10/infra/docker-compose.yml:1`
- `10-NET10/infra/nginx.conf:1`

```powershell
if (Test-Path .\10-NET10\infra) { Set-Location .\10-NET10\infra } elseif (Test-Path .\infra) { Set-Location .\infra }
docker compose up -d
```
...
Code source a observer:
- `10-NET10/PerimeterValidationLab.Tests/PerimeterValidationTests.cs:6`
