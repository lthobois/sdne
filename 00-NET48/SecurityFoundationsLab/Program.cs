...
internal static class Program
{
    ...
    {
        new Endpoint("GET", "/"),
        new Endpoint("GET", "/runtime/stack-depth"),
        new Endpoint("GET", "/secure/assembly/integrity"),
        new Endpoint("GET", "/secure/clickjacking/page"),
        new Endpoint("GET", "/secure/dll/search-order"),
        new Endpoint("GET", "/secure/resource/cpu"),
        new Endpoint("GET", "/vuln/clickjacking/page"),
        new Endpoint("GET", "/vuln/dll/search-order"),
        new Endpoint("GET", "/vuln/resource/cpu"),
    ...
    private static void Main(string[] args)
    {
        ...
        listener.Start();
        Console.WriteLine("SecurityFoundationsLab NET48 compat host listening on: " + string.Join(", ", listener.Prefixes.Cast<string>()));
    ...
    private static void Handle(HttpListenerContext ctx)
    {
        ...
        if (path == "/")
        {
            ...
            WriteJson(ctx.Response, 200, "{\"workshop\":\"00-NET48\",\"application\":\"SecurityFoundationsLab\",\"net48Compat\":true,\"endpoints\":[" + endpoints + "]}");
            return;
        }
        ...
        var payload = "{" +
            "\"workshop\":\"00-NET48\"," +
            "\"application\":\"SecurityFoundationsLab\"," +
            "\"net48Compat\":true," +
            "\"mode\":\"" + Escape(mode) + "\"," +
