# Atelier 09 - Durcissement AuthN/AuthZ (.NET 10)
...
- `09-NET10/AuthzHardeningLab/Program.cs:15`
- `09-NET10/AuthzHardeningLab/Security/TokenService.cs:10`
- `09-NET10/AuthzHardeningLab/Security/DocumentStore.cs:3`

```powershell
if (Test-Path .\09-NET10) { Set-Location .\09-NET10 }
...
Code source a observer:
- `09-NET10/AuthzHardeningLab/Program.cs:21`
- `09-NET10/AuthzHardeningLab/Program.cs:27`
- `09-NET10/AuthzHardeningLab/Security/TokenService.cs:18`
...
Code source a observer:
- `09-NET10/AuthzHardeningLab/Program.cs:49`
- `09-NET10/AuthzHardeningLab/Security/TokenService.cs:64`
- `09-NET10/AuthzHardeningLab/Security/DocumentStore.cs:12`
...
Code source a observer:
- `09-NET10/AuthzHardeningLab/Program.cs:87`
- `09-NET10/AuthzHardeningLab/Security/TokenService.cs:64`
...
Code source a observer:
- `09-NET10/AuthzHardeningLab/Program.cs:33`
...
Code source a observer:
- `09-NET10/AuthzHardeningLab.Tests/AuthzHardeningTests.cs:8`
